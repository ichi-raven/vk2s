...
void pathtracing()
{
    ...
    try
    {
        ...
        auto window = device.create<vk2s::Window>(width, height, 3, "pathtracing window");
        ...
        load("../../examples/resources/model/CornellBox/CornellBox-Water.obj", device, loader, meshInstances, materialBuffer, instanceMapBuffer, materialTextures);
